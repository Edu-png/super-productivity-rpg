...
export enum LS {
  ...
  RPG_PROFILE = 'SUP_RPG_PROFILE_V1',
  TASK_HABITS = 'SUP_TASK_HABITS_V1',
  RPG_AUTO_BACKUP_LAST_DATE = 'SUP_RPG_AUTO_BACKUP_LAST_DATE',
  RPG_AUTO_BACKUP_EXTRA_DIR = 'SUP_RPG_AUTO_BACKUP_EXTRA_DIR',
}
