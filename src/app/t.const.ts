const T = {
  ...
  F: {
    ...
    SCHEDULE: {
      ...
      NOW: 'F.SCHEDULE.NOW',
      OVERAGE_TOOLTIP: 'F.SCHEDULE.OVERAGE_TOOLTIP',
      UNDERAGE_TOOLTIP: 'F.SCHEDULE.UNDERAGE_TOOLTIP',
      FAILED_TOOLTIP: 'F.SCHEDULE.FAILED_TOOLTIP',
    ...
    TASK: {
      ...
      CMP: {
        ...
        MARK_FAILED: 'F.TASK.CMP.MARK_FAILED',
        VIEW_NOTES: 'F.TASK.CMP.VIEW_NOTES',
        MOVE_TO_TASK: 'F.TASK.CMP.MOVE_TO_TASK',
      ...
      D_TIME: {
        ...
        FOCUS_BLOCK_COUNT: 'F.TASK.D_TIME.FOCUS_BLOCK_COUNT',
        FOCUS_BLOCK_SUMMARY: 'F.TASK.D_TIME.FOCUS_BLOCK_SUMMARY',
